(ns criterium.viewer.kindly-basic-views-test
  ;; Tests for basic statistics and visualization views in the Kindly viewer.
  ;; Covers: stats, extremes, quantiles, outlier-counts, collect-plan, samples,
  ;; histogram, sample-percentiles, metrics, event-stats, outlier-significance,
  ;; sample-diffs, and noop views.
  (:require
