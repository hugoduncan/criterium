...
;;; Mutable deftype implementation
...
;;; Legacy lazy-seq implementation (deprecated, use WellRng1024a)

(defn well-rng-1024a
  "Well RNG 1024a.
  Returns a lazy sequence of random doubles in [0,1).

  DEPRECATED: Use make-well-rng-1024a and next-double! for better performance.
